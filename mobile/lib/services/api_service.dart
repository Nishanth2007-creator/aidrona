...
class ApiService {
  ...
  static String get _baseUrl {
    if (kDebugMode) {
      ...
      if (defaultTargetPlatform == TargetPlatform.android) {
        // Use 10.126.159.119 for physical device, 10.0.2.2 for Android emulator
        return 'http://10.126.159.119:8085/api'; 
      }
  ...
  Future<Map<String, dynamic>> verifyDoctor(String regId,
      {String? phone}) async {
